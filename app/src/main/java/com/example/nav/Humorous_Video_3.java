...
public class Humorous_Video_3 extends AppCompatActivity {
    VideoView videoView;
    ProgressDialog pd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_humorous__video_3);
        Firebase.setAndroidContext(this);
        pd = new ProgressDialog(this);
        pd.setMessage("Loading...");
        backhum1 = findViewById(R.id.humback3);
        videoView = findViewById(R.id.vView3);
        pb = findViewById(R.id.humprogressBar3);
        pb.setMax(100);
        curr = findViewById(R.id.humcurrent3);
        fs = findViewById(R.id.humfs3);
        curr = findViewById(R.id.humcurrent3);
        tot = findViewById(R.id.humtotal3);
        ...
        String str = "https://firebasestorage.googleapis.com/v0/b/flyapp-84c6a.appspot.com/o/Videos%2FHumorous%2FKota%20Factory(Chemistry).mp4?alt=media&token=4af6fe56-932f-4584-a15e-7c5b930951a8";
        ...
        imgplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isPlaying==false){
                    Humorous_Video_3.VideoProgress vp = new Humorous_Video_3.VideoProgress();
