...
public class Motivational_Video_5 extends AppCompatActivity {
    VideoView videoView;
    ProgressDialog pd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_motivational__video_5);
        Firebase.setAndroidContext(this);
        pd = new ProgressDialog(this);
        pd.setMessage("Loading...");
        backmot1 = findViewById(R.id.motback5);
        pb = findViewById(R.id.motprogressBar5);
        pb.setMax(100);
        curr = findViewById(R.id.motcurrent5);
        fs = findViewById(R.id.motfs5);
        videoView = findViewById(R.id.vView5);
        curr = findViewById(R.id.motcurrent5);
        tot = findViewById(R.id.mottotal5);
        ...
        String str = "https://firebasestorage.googleapis.com/v0/b/flyapp-84c6a.appspot.com/o/Videos%2FMotivational1%2FTony%20Stark%20-%20Purpose.mp4?alt=media&token=1e496ca5-811b-4a78-92e9-4020fe515e06";
        ...
        imgplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isPlaying==false){
                    Motivational_Video_5.VideoProgress vp = new Motivational_Video_5.VideoProgress();
