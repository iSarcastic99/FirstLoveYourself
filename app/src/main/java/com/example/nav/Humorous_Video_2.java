...
public class Humorous_Video_2 extends AppCompatActivity {
    VideoView videoView;
    ProgressDialog pd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_humorous__video_2);
        Firebase.setAndroidContext(this);
        pd = new ProgressDialog(this);
        pd.setMessage("Loading...");
        backhum1 = findViewById(R.id.humback2);
        videoView = findViewById(R.id.vView2);
        pb = findViewById(R.id.humprogressBar2);
        pb.setMax(100);
        curr = findViewById(R.id.humcurrent2);
        fs = findViewById(R.id.humfs2);
        curr = findViewById(R.id.humcurrent2);
        tot = findViewById(R.id.humtotal2);
        ...
        String str = "https://firebasestorage.googleapis.com/v0/b/flyapp-84c6a.appspot.com/o/Videos%2FHumorous%2FBest%20Of%20Bagga-1%20(College%20Romance).mp4?alt=media&token=1bbef4d0-35cf-40cb-8fa2-3e73bf265e86";
        ...
        imgplay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isPlaying==false){
                    Humorous_Video_2.VideoProgress vp = new Humorous_Video_2.VideoProgress();
