...
public class ContactUs extends AppCompatActivity implements AIListener{
    ...
    String phone, S;
    FirebaseRecyclerAdapter<ChatMessage, ChatRecording> adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new FirebaseRecyclerAdapter<ChatMessage, ChatRecording>(ChatMessage.class, R.layout.msglist, ChatRecording.class, ref.child("chatbot").child(phone).child("chat")) {
            @Override
            protected void populateViewHolder(ChatRecording viewHolder, ChatMessage model, int position) {
                if (model.getMsgUser().equals(phone)) {
                    ...
                    if (model.getMsgText().equals("")) {
                        viewHolder.leftText.setText("As I am a programmed bot so I am unable to answer your complex questions like this, please contact us on firstloveyourself1999@gmail.com.");
                        if(!isFisrtTime) {
