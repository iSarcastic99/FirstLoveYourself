...
public class CounselorDetails extends AppCompatActivity {
    Intent intent;
    String CounselorNumber, Title, Description, Phone, Email, ImageURL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reff = FirebaseDatabase.getInstance().getReference().child("counselors").child("Counselor" + CounselorNumber);
